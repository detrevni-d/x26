...
class AllDefectsV32InferenceParams(BaseModel):
    torch_config: List[TorchConfig] = [
        TorchConfig(name="float32_matmul_precision", value="medium")
    ]

    transforms: TransformConfig = TransformConfig(name="vjt_all_defects_v32")
...
all_defects_v32_defaults = AllDefectsV32InferenceParams()
